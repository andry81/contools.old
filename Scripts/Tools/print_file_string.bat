...
if not defined CONTOOLS_OLD_ROOT set "CONTOOLS_OLD_ROOT=%?~dp0%"
rem set "CONTOOLS_OLD_ROOT=%CONTOOLS_OLD_ROOT:\=/%"
if "%CONTOOLS_OLD_ROOT:~-1%" == "\" set "CONTOOLS_OLD_ROOT=%CONTOOLS_OLD_ROOT:~0,-1%"
