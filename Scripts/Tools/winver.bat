...
rem Windows 2000
call "%%CONTOOLS_OLD_ROOT%%/setvarfromstd.bat" ver%%%%?2%%%% "%%SystemRoot%%\System32\findstr.exe" /I /R /C:"Windows[%%?0%%a-zA-Z0-9\\/][%%?0%%a-zA-Z0-9\\/]*2000"
...
call "%%CONTOOLS_OLD_ROOT%%/setvarfromstd.bat" @"%%SystemRoot%%\System32\reg.exe" query "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion" /v "ProductName" %%%%?2%%%% "%%SystemRoot%%\System32\findstr.exe" /I /R /C:"ProductName[%%?0%%a-zA-Z0-9\\/][%%?0%%a-zA-Z0-9\\/]*REG_[A-Z][A-Z]*" 2>nul
...
rem Windows XP
call "%%CONTOOLS_OLD_ROOT%%/setvarfromstd.bat" echo "%%WINVER_VALUE_FULL%%"%%%%?2%%%% "%%SystemRoot%%\System32\findstr.exe" /I /R /C:"Windows[%%?0%%a-zA-Z0-9\\/][%%?0%%a-zA-Z0-9\\/]*XP"
...
rem Windows Vista
call "%%CONTOOLS_OLD_ROOT%%/setvarfromstd.bat" echo "%%WINVER_VALUE_FULL%%"%%%%?2%%%% "%%SystemRoot%%\System32\findstr.exe" /I /R /C:"[%%?0%%a-zA-Z0-9\\/][%%?0%%a-zA-Z0-9\\/]*Vista[%%?0%%a-zA-Z0-9\\/]*"
if not "%STDOUT_VALUE:~1,-1%" == "~1,-1" (
...
rem Windows 7
call "%%CONTOOLS_OLD_ROOT%%/setvarfromstd.bat" echo "%%WINVER_VALUE_FULL%%"%%%%?2%%%% "%%SystemRoot%%\System32\findstr.exe" /I /R /C:"Windows[%%?0%%a-zA-Z0-9\\/][%%?0%%a-zA-Z0-9\\/]*7"
if not "%STDOUT_VALUE:~1,-1%" == "~1,-1" (
...
rem Windows 8
call "%%CONTOOLS_OLD_ROOT%%/setvarfromstd.bat" echo "%%WINVER_VALUE_FULL%%"%%%%?2%%%% "%%SystemRoot%%\System32\findstr.exe" /I /R /C:"Windows[%%?0%%a-zA-Z0-9\\/][%%?0%%a-zA-Z0-9\\/]*8"
if not "%STDOUT_VALUE:~1,-1%" == "~1,-1" (
...
call "%%CONTOOLS_OLD_ROOT%%/setvarfromstd.bat" echo "%%WINVER_VALUE_FULL%%"%%%%?2%%%% "%%SystemRoot%%\System32\findstr.exe" /I /R /C:"Server[%%?0%%a-zA-Z0-9\\/][%%?0%%a-zA-Z0-9\\/]*2003"
if not "%STDOUT_VALUE:~1,-1%" == "~1,-1" (
...
call "%%CONTOOLS_OLD_ROOT%%/setvarfromstd.bat" echo "%%WINVER_VALUE_FULL%%"%%%%?2%%%% "%%SystemRoot%%\System32\findstr.exe" /I /R /C:"Server[%%?0%%a-zA-Z0-9\\/][%%?0%%a-zA-Z0-9\\/]*2008[%%?0%%a-zA-Z0-9\\/][%%?0%%a-zA-Z0-9\\/]*R2"
if not "%STDOUT_VALUE:~1,-1%" == "~1,-1" (
...
call "%%CONTOOLS_OLD_ROOT%%/setvarfromstd.bat" echo "%%WINVER_VALUE_FULL%%"%%%%?2%%%% "%%SystemRoot%%\System32\findstr.exe" /I /R /C:"Server[%%?0%%a-zA-Z0-9\\/][%%?0%%a-zA-Z0-9\\/]*2008[%%?0%%a-zA-Z0-9\\/][%%?0%%a-zA-Z0-9\\/]*R1"
if not "%STDOUT_VALUE:~1,-1%" == "~1,-1" (
...
call "%%CONTOOLS_OLD_ROOT%%/setvarfromstd.bat" echo "%%WINVER_VALUE_FULL%%"%%%%?2%%%% "%%SystemRoot%%\System32\findstr.exe" /I /R /C:"Server[%%?0%%a-zA-Z0-9\\/][%%?0%%a-zA-Z0-9\\/]*2008"
if not "%STDOUT_VALUE:~1,-1%" == "~1,-1" (
...
call "%%CONTOOLS_OLD_ROOT%%/setvarfromstd.bat" ver
