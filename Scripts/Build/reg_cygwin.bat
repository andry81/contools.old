...
call "%%CONTOOLS_OLD_ROOT%%/setvarfromstd.bat" "%%CYGWIN_PATH%%\bin\cygpath.exe" -u "%%CONTOOLS_ROOT%%"
...
(
  ...
  call :RESET_ENV_AND_CALL vars_win2k.lst "%%CONTOOLS_OLD_ROOT_NATIVE%%" "%%CONFIG_PATH%%" "%%CYGWIN_PATH%%"
)
exit /b
...
(
  ...
  call :RESET_ENV_AND_CALL vars_winxp.lst "%%CONTOOLS_OLD_ROOT_NATIVE%%" "%%CONFIG_PATH%%" "%%CYGWIN_PATH%%"
)
exit /b
...
(
  ...
  call :RESET_ENV_AND_CALL vars_vista.lst "%%CONTOOLS_OLD_ROOT_NATIVE%%" "%%CONFIG_PATH%%" "%%CYGWIN_PATH%%"
)
exit /b
...
(
  ...
  call :RESET_ENV_AND_CALL vars_win7.lst "%%CONTOOLS_OLD_ROOT_NATIVE%%" "%%CONFIG_PATH%%" "%%CYGWIN_PATH%%"
)
exit /b
...
(
  ...
  call :RESET_ENV_AND_CALL vars_win8.lst "%%CONTOOLS_OLD_ROOT_NATIVE%%" "%%CONFIG_PATH%%" "%%CYGWIN_PATH%%"
)
exit /b
