...
call "%%CONTOOLS_ROOT%%/std/canonical_path.bat" CONTOOLS_OLD_ROOT  "%%CONTOOLS_OLD_ROOT%%"
set "CONTOOLS_ROOT_NATIVE=%CONTOOLS_ROOT%"
set "CONTOOLS_OLD_ROOT_NATIVE=%CONTOOLS_OLD_ROOT%"
...
:CHECK_CMD
call "%%CONTOOLS_OLD_ROOT%%/isnativecmd.bat"
if %ERRORLEVEL% NEQ 0 (
...
call "%%CONTOOLS_OLD_ROOT%%/strchr.bat" /v
if not %ERRORLEVEL% GEQ 0 goto CHECK_CYGWIN_VARS

call "%%CONTOOLS_OLD_ROOT%%/stresc.bat" /v __STRING__ STRING_ESCAPED __CHARS__ {EC} {#}
...
call "%%CONTOOLS_OLD_ROOT%%/setvarsfromfile.bat" "%%CONFIG_PATH%%\cygwin.vars"
...
call "%%CONTOOLS_ROOT%%/cygwin/cygver.bat" cygwin "%%CYGWIN_PATH%%"
if %ERRORLEVEL% NEQ 0 (
...
call "%%CONTOOLS_OLD_ROOT%%/setvarfromstd.bat" "%%CYGWIN_PATH%%\bin\cygpath.exe" -u "%%TEMP%%"
set "CYGDRIVE_TEMP=%STDOUT_VALUE%"

call "%%CONTOOLS_OLD_ROOT%%/setvarfromstd.bat" "%%CYGWIN_PATH%%\bin\cygpath.exe" -u "%%TMP%%"
set "CYGDRIVE_TMP=%STDOUT_VALUE%"

call "%%CONTOOLS_OLD_ROOT%%/setvarfromstd.bat" "%%CYGWIN_PATH%%\bin\cygpath.exe" -u "%%CONTOOLS_OLD_ROOT%%"
...
"%CYGWIN_PATH%\bin\bash" "%CYGDRIVE_CONTOOLS_ROOT%/bash/unmountdir.sh" "/usr/local"
if %ERRORLEVEL% EQU 0 echo /usr/local

"%CYGWIN_PATH%\bin\bash" "%CYGDRIVE_CONTOOLS_ROOT%/bash/unmountdir.sh" "/usr"
...
"%CYGWIN_PATH%\bin\bash" "%CYGDRIVE_CONTOOLS_ROOT%/bash/mountdir.sh" "%TMP%" "/tmp"
if %ERRORLEVEL% NEQ 0 (
...
"%CYGWIN_PATH%\bin\bash" "%CYGDRIVE_CONTOOLS_ROOT%/bash/mountdir.sh" "%MINGW_PATH%" "/mingw"
if %ERRORLEVEL% NEQ 0 (
...
set "CONTOOLS_OLD_ROOT=%CONTOOLS_OLD_ROOT_NATIVE%"
...
call "%%CONTOOLS_OLD_ROOT%%/winver.bat"

rem Reset environment
call "%%CONTOOLS_OLD_ROOT%%/setvarfromstd.bat" "%%CONTOOLS_OLD_ROOT%%\splitvars.bat" "%%WINVER_VALUE%%" "|" "-s"
...
(
  ...
  call :RESET_ENV_AND_CALL vars_win2k.lst "%%CONTOOLS_OLD_ROOT_NATIVE%%" "%%CONFIG_PATH%%" "%%CYGWIN_PATH%%" "%%CYGDRIVE_TEMP%%" "%%CYGDRIVE_TMP%%" "%%CYGDRIVE_CONTOOLS_ROOT%%"
)
exit /b
...
(
  ...
  call :RESET_ENV_AND_CALL vars_winxp.lst "%%CONTOOLS_OLD_ROOT_NATIVE%%" "%%CONFIG_PATH%%" "%%CYGWIN_PATH%%" "%%CYGDRIVE_TEMP%%" "%%CYGDRIVE_TMP%%" "%%CYGDRIVE_CONTOOLS_ROOT%%"
)
exit /b
...
(
  ...
  call :RESET_ENV_AND_CALL vars_vista.lst "%%CONTOOLS_OLD_ROOT_NATIVE%%" "%%CONFIG_PATH%%" "%%CYGWIN_PATH%%" "%%CYGDRIVE_TEMP%%" "%%CYGDRIVE_TMP%%" "%%CYGDRIVE_CONTOOLS_ROOT%%"
)
exit /b
...
(
  ...
  call :RESET_ENV_AND_CALL vars_win7.lst "%%CONTOOLS_OLD_ROOT_NATIVE%%" "%%CONFIG_PATH%%" "%%CYGWIN_PATH%%" "%%CYGDRIVE_TEMP%%" "%%CYGDRIVE_TMP%%" "%%CYGDRIVE_CONTOOLS_ROOT%%"
)
exit /b
...
(
  ...
  call :RESET_ENV_AND_CALL vars_win8.lst "%%CONTOOLS_OLD_ROOT_NATIVE%%" "%%CONFIG_PATH%%" "%%CYGWIN_PATH%%" "%%CYGDRIVE_TEMP%%" "%%CYGDRIVE_TMP%%" "%%CYGDRIVE_CONTOOLS_ROOT%%"
)
exit /b
...
call "%%CONTOOLS_OLD_ROOT%%/resetenv.bat" -p -e "%%~3\env\%%~1"

rem Return variables
set "OLDPATH=%PATH%"
set "CONTOOLS_OLD_ROOT_NATIVE=%~2"
set "TEMP=%~5"
set "TMP=%~6"
set "CONTOOLS_ROOT=%~7"
